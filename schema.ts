...
// ClientData table removed - consolidated into users table for better performance
...
// insertClientDataSchema removed - client data now part of users table
...
// ClientData types removed - data consolidated into User types
