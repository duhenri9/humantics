    ...
    <>
      ...
      >
        <motion.button
          ...
          className="bg-gradient-to-r from-[#6D7AFF] to-[#5A67F0] hover:from-[#5A67F0] hover:to-[#4854E0] text-white rounded-full p-4 shadow-xl transition-all duration-300 group relative bg-red-500"
          style={{
